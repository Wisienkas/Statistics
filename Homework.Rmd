...
#### c. Suppose the null hypothesis is � = 5 and we fail to reject H 0 . Under this scenario, the true population mean is 5.
...
#### f.  A cutoff of ?? = 0.05 is the ideal value for all hypothesis tests.
